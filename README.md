...
4. Changed root window default opening size from top left corner to the screen's center (using xxmbabanexx's answer on a [link to StackOverflow topic!] (https://stackoverflow.com/questions/14910858/how-to-specify-where-a-tkinter-window-opens).
